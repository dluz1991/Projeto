...
public class TugaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "TYPE", "LPAREN", "RPAREN", "PLUS", "MINUS", "TIMES", 
			"DIV", "REMAINDER", "LESS", "GREATER", "LESSEQUAL", "GREATEREQUAL", "EQUAL", 
			"DIFFERENT", "AND", "OR", "NOT", "INT", "REAL", "STRING", "BOOL", "ID", 
			"SCOMMA", "SL_COMMENT", "ML_COMMENT", "WS", "DIGIT"
		};
	}
